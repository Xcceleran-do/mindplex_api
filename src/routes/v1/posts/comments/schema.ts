...
export const createCommentDocs = describeRoute({
    ...
    security: [{ bearerAuth: [] }],
    description: 'Creates a comment on a post. Requires authentication. All comments start as pending until approved by moderation.',
    responses: {
        201: { description: 'Created', content: { 'application/json': { schema: resolver(CommentRecordSchema) } } },
