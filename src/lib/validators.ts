...
export const PaginationLimitSchema = v.optional(
  v.pipe(v.string(), v.transform(Number), v.integer(), v.minValue(1), v.maxValue(PAGINATION_RULES.MAX_LIMIT)),
...
export const IdParamSchema = v.pipe(v.string(), v.transform(Number), v.integer(), v.minValue(1));
