...
export const friendRequests = pgTable(
  ...
  (table) => [
    unique("friend_requests_pair_idx").on(table.requesterId, table.requestedId),
...
export const commentReactions = pgTable(
  ...
  (table) => [
    unique("comment_reactions_user_comment_idx").on(table.commentId, table.userId),
...
export const postEmojis = pgTable(
  ...
  (table) => [
    unique("post_emojis_user_post_emoji_idx").on(table.postId, table.userId, table.emojiValue),
...
export const shares = pgTable(
  ...
  (table) => [index("shares_post_id_idx").on(table.postId), index("shares_user_id_idx").on(table.userId)],
);
...
export const peoplesChoiceVotes = pgTable(
  ...
  (table) => [unique("peoples_choice_user_post_idx").on(table.userId, table.postId)],
);
